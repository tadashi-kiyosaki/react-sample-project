    ...
    return (
      <View>
        <ScrollView
              ...
              <View>
                <View style={styles.container4}>
                  <View>
                    ...
                    <Text style={[styles.optionMemo, styles.textNormal]}>19</Text>
                  </View>
                  <View style={{marginLeft: 15}}>
                    <Image source={require('../../assets/image1/images/close.png')} />
                    <Text style={[styles.optionMemo, styles.textNormal]}>2</Text>
                  </View>
                </View>
              </View>
            </View>
          ...
          <View style={styles.childScrollCon}>
            <ScrollView 
            scrollEnabled={true}>
              {/* // style={styles.root1}
              ...
              <View style={{flex: 1, flexGrow: 1}}>
                <Text style={styles.profileText1}>Watch Joel Sartore on the next edition of 60 Minutes  and see what it takes to create the Photo Ark. The episode airs this Sunday, October 14...</Text>
                <Text style={styles.profileText1}>Watch Joel Sartore on the next edition of 60 Minutes  and see what it takes to create the Photo Ark. The episode airs this Sunday, October 14...</Text>
                <Text style={styles.profileText1}>Watch Joel Sartore on the next edition of 60 Minutes  and see what it takes to create the Photo Ark. The episode airs this Sunday, October 14...</Text>
              </View>
              ...
              <View style={styles.markCon}>
                <Text style={[styles.textNormal, styles.textuser4]}>Click to read more</Text>
              </View> */}
            </ScrollView>
          </View>
