...
export class NewShare extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      route: 'Login',
    ...
    return (
      <View>
        <ScrollView
          ...
          <View style={styles.smileCon2}>
            <View></View>
            <Image style={{ marginTop: -10 }} source={require('../../assets/image1/images/smile_icon.png')} />
          </View>
          <View style={styles.pollBox}>
            <TextInput
              style={styles.searchInput1}
          ...
          <View style={styles.choiceCon}>
            <Image style={{marginTop: 5}}source={require('../../assets/image1/images/plus.png')} />
            <Text style={[styles.choiceText]}>  Add a choice</Text>
          </View>
...
const styles = RkStyleSheet.create(theme => ({
  ...
  smileCon2: {
    flexDirection:"row", justifyContent: "space-between", width: "100%", marginTop: -38, padding: 10
  }
}));
