...
export class ViewAds extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      route: 'Login',
    ...
    return (
      <View>
        <ScrollView
          ...
          <Image style={styles.chartPic} source={require('../../assets/image1/images/ads/maxresdefault.jpg')} />
          <View style={styles.historyCon}>
            ...
            <View style={[styles.myadsCol1, styles.historyBut]}>
              ...
              <Text style={styles.optionButText}> γ$180 </Text>
            </View>
            <View style={[styles.myadsCol3, styles.historyBut]}>
              <Text style={styles.optionButText}> ONE MONTH </Text>
              <Text style={styles.optionButText}> PLAN </Text>
            </View>
            <View style={[styles.myadsCol4, styles.historyBut]}>
              <Text style={styles.optionButText}> ENTRY PERIOD </Text>
              <Text style={styles.optionButText}> FILTER </Text>
            </View>
          </View>
          <Text style={[styles.sendText, styles.textNormal]}>TOTAL IMPRESSIONS</Text>
          <View style={styles.ballance}>
            <Text style={styles.money}>438,908</Text>
          </View>
          <Text style={[styles.sendText, styles.textNormal]}>NEW READERS</Text>
          <View style={styles.ballance}>
            <Text style={styles.money}>1,210</Text>
          </View>
          <Text style={[styles.sendText, styles.textNormal]}>MEDIA ENGAGEMENTS</Text>
          <View style={styles.ballance}>
            <Text style={styles.money}>42,541</Text>
          </View>
          <Text style={[styles.sendText, styles.textNormal]}>NEW AGREES</Text>
          <View style={styles.ballance}>
            <Text style={styles.money}>12,860</Text>
          </View>
...
const styles = RkStyleSheet.create(theme => ({
  ...
  myadsCol4: {
    backgroundColor: "rgb(144, 161, 78)"
  },
  pickerStyle: {
    height: 45,
    width: "100%",
