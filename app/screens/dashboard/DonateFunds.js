...
export class DonateFunds extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      route: 'Login',
    ...
    return (
      <View>
        <ScrollView
          ...
          <Text style={[styles.sendText, styles.textNormal]}>UPDATED BALANCE</Text>
          ...
          <Text style={[styles.sendText, styles.textNormal]}>@JOURNILE PAD</Text>
          <View style={styles.searchBox}>
            <TextInput
              style={styles.searchInput}
              placeholder='@childrenecenter'
