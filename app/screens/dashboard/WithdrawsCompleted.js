...
export class WithdrawsCompleted extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      route: 'Login',
        ...
        <ScrollView
          ...
          <View style={styles.chartCon}>
            <View style={styles.chartTitleCon}>
              <Text style={styles.chartText}>Withdrawals Completed</Text>
          ...
          <View style={styles.tableCon}>
            ...
            <View style={styles.tableCon1}>
              ...
              <View style={styles.status}>
                <Text style={styles.tableDataText}>γ$71 Withdrawn with ref: 7Y42QM</Text>
              </View>
              <View style={styles.action}>
